...
interface DictionaryServiceInterface
{
     ...
     */
    public function getOptionByDictKey(string $dictKey, int $orgId, string $systemId = null, array $menuId = null): array;
     ...
     * @time 2024/1/22 17:26
     */
    public function getOptionByDictKeys(array $dictKeys, int $orgId, string $systemId = null, array $menuId = null): array;
