...
interface SdHdRelationServiceInterface
{
     ...
     */
    public function getSdIdByHdId(array $sdIds,int $org_id, int $system_id = null):array;
     ...
     * @return array ['111'=>[111,2222],'2222'=>[3333,444]]
     */
    public function getHdIdBySdId(array $hdIds,int $org_id, int $system_id = null):array;
